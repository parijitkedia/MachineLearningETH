...
with zipfile.ZipFile(sub) as file:
	file.extractall(path="/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/")

subfiles = os.listdir("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/")
...
# Check src folder
if found['src'] == 1:
	srcFiles = os.listdir("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/src")
	if len(srcFiles) == 0:
		print( "WARNING: No files in folder src")

# Check final_sub.csv
if found['final_sub.csv'] == 1:
	#finalSub = np.loadtxt("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2//final_sub.csv",dtype=str,delimiter=",")
	lines = open("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/final_sub.csv")
...
if found['predict_final'] == 1:
	for ext in ['.py','.m']:
		if os.path.exists("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/predict_final"+ext):
			fileSize = os.stat("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/predict_final"+ext).st_size
			if fileSize == 0:
...
if found['readme'] == 1:
	lines = []
	with open("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/readme") as readme:
		for line in readme:
			if line[0] != "#":
				lines.append(line)
...
# Delete /Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/

rmtree("/Users/parijitkedia/Desktop/Python/Parijitkedia/ML/MLP2/MLP2_DOTA2/")
